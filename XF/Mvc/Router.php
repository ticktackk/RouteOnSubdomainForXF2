...
class Router extends XFCP_Router
{
     ...
     * @var bool
     */
    protected $hasRoutesOnSubdomain = false;
    ...
    /**
     * Sets $hasRoutesOnSubdomain value when route filter is set which is only allowed for pub router (2.1.* <=)
     *
     * @param string $name
    ...
    public function addRoutePreProcessor($name, $preProcessor, $beginning = false)
    {
        ...
        {
            $app = $this->app();
            $this->hasRoutesOnSubdomain = $app->container('router.public.hasRoutesOnSubdomain');
        }
